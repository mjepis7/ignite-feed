...
// state = variaveis que eu quero que o componente monitore
...
export function Post({ post }: PostProps) {
  ...
  function deleteComment(commentToDelete: string) {
    // imutabilidade -> as variaveis não sofrem mutação, ou seja, nunca se altera um valor de uma variavel na memoria
